...
// import { ogrencininOdemeleri, tumYapilanDersler } from '../utils/database';

// export default function AnaSayfa() {
//     const navigation = useNavigation();
//     const [bugununRandevulari, setBugununRandevulari] = useState([]);
//     const [sonDersler, setSonDersler] = useState([]);

//     // Örnek veriler - gerçek uygulamada veritabanından çekilecek
//     useEffect(() => {
//         // Bugünün randevuları (simüle edilmiş)
//         setBugununRandevulari([
//             { id: 1, ogrenciAdi: 'Ahmet Yılmaz', saat: '14:00', ders: 'Matematik' },
//             { id: 2, ogrenciAdi: 'Ayşe Demir', saat: '16:30', ders: 'Fizik' }
//         ]);
//         // Son yapılan dersler 
...
//                 console.log("anasayfa_dersler", yapilanDersler.yapilanDersler);
...
//                             <Text style={styles.bosRandevuText}>Bugün için randevu bulunmamaktadır</Text>
//                         </View>
//                     )}
//                 </View>
...
export default function AnaSayfa() {
    ...
    return (
        <View style={styles.container}>
            {/* Başlık */}
            <View style={styles.header}>
                <Text style={styles.headerTitle}>Öğretmen Panel</Text>
                <Text style={styles.headerDate}>{getTodayDate()}</Text>
            </View>
